    ...
    <div class="h-20 flex-shrink-0 flex">
      ...
      <div class="flex-1 flex justify-end items-end mr-16">
        <div class="flex items-center">
          ...
          <button class="border-2 border-gray-600 rounded px-3 py-1 font-bold mx-2 hover:bg-gray-500 hover:bg-opacity-25 focus:outline-none" @click="selectedDate = Date.now()">Aujoud'hui</button>
          <button
            class="rounded-full hover:bg-gray-500 hover:bg-opacity-25 p-1 focus:outline-none"
            @click="day++"
          >
