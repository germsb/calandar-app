<template>
  <div class="flex p-5 flex-col select-none">
    <div class="flex font-bold text-gray-700 pl-3 mb-4">
      <c-icon
        viewBox="0 0 20 20"
        data-icon="test"
    ...
    <div class="mt-3 flex flex-col">
      <div
        ...
        @click="changeGuide(i)"
        :class="
          'p-1 mb-2 bg-white rounded-full flex cursor-pointer items-center transition-all duration-200 border border-gray-400 shadow-xl ' +
